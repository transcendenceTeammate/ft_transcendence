...
def login(request):
	...
	response.set_cookie('access_token', str(access_token), httponly=False, secure=True, samesite='Lax', domain='.app.10.24.102.1.nip.io')
	return response
...
def get_access_token(request):
	if request.method == "POST":
		...
		redirect_uri = "http://10.24.102.1.nip.io:8000/auth42/"
